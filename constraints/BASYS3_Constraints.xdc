...
## Switches
#set_property PACKAGE_PIN V17 [get_ports {INPUT_SIGNAL[0]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[0]}]
#set_property PACKAGE_PIN V16 [get_ports {INPUT_SIGNAL[1]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[1]}]
#set_property PACKAGE_PIN W16 [get_ports {INPUT_SIGNAL[2]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[2]}]
#set_property PACKAGE_PIN W17 [get_ports {INPUT_SIGNAL[3]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[3]}]
#set_property PACKAGE_PIN W15 [get_ports {INPUT_SIGNAL[4]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[4]}]
#set_property PACKAGE_PIN V15 [get_ports {INPUT_SIGNAL[5]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[5]}]
#set_property PACKAGE_PIN W14 [get_ports {INPUT_SIGNAL[6]}]					
#	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[6]}]
...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports {INPUT_SIGNAL[8]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[8]}]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {INPUT_SIGNAL[9]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[9]}]
##Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {INPUT_SIGNAL[10]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[10]}]
##Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {INPUT_SIGNAL[11]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[11]}]
##Sch name = JB7
set_property PACKAGE_PIN A15 [get_ports {INPUT_SIGNAL[12]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[12]}]
##Sch name = JB8
set_property PACKAGE_PIN A17 [get_ports {INPUT_SIGNAL[13]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[13]}]
##Sch name = JB9
set_property PACKAGE_PIN C15 [get_ports {INPUT_SIGNAL[14]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[14]}]
##Sch name = JB10 
...
##Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports OUTPUT_SIGNAL]					
...
##Sch name = JC9
set_property PACKAGE_PIN P17 [get_ports {INPUT_SIGNAL[6]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[6]}]
#Sch name = JC10
set_property PACKAGE_PIN R18 [get_ports {INPUT_SIGNAL[7]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {INPUT_SIGNAL[7]}]
